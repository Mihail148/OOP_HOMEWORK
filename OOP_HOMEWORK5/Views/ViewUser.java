...
import OOP_HOMEWORK5.Model.Fields;
import OOP_HOMEWORK5.Model.User;
import OOP_HOMEWORK5.Utilities.PhoneException;
import OOP_HOMEWORK5.Utilities.Validate;

public class ViewUser {
    private final UserControllers userController;
    private final Validate validate;

    public ViewUser(UserControllers userController, Validate validate) {
    ...
    private void read() throws Exception {
        ...
        User user_ = UserControllers.readUser(id);
    ...
    private void update() throws Exception {
        ...
        User _user = UserControllers.readUser(userid);
        UserControllers.updateUser(_user, Fields.valueOf(field_name.toUpperCase()), param);
    }
    ...
    private void list() throws Exception {
        for (User user : UserControllers.getUsers()) {
